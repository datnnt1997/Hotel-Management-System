...
namespace DataTranferObject
{
    public class ReservationDTO
    {
        ...
        public ReservationDTO(int reserID, string cID, int eID, string rID, string checkIn, string checkOut, string status)
        {
        ...
        public int ReserID { get => reserID; set => reserID = value; }
